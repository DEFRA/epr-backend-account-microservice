...
{
    Task<Result<ComplianceSchemeMembershipResponse>> GetComplianceSchemeMembersAsync(Guid organisationId, Guid complianceSchemeId, string? query, int pageSize, int page);
