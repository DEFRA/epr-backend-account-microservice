...
/// Test classes share this via <see cref="AccountApiCollection"/> and use unique IDs
...
public sealed class AccountApiFactory : WebApplicationFactory<Program>, IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        var databaseName = "Accounts_" + Guid.NewGuid().ToString("N")[..12];
    ...
    protected override void ConfigureWebHost(IWebHostBuilder builder)
    {
        ...
        builder.ConfigureAppConfiguration((_, config) =>
        {
            ...
            {
                ["ConnectionStrings:AccountsDatabase"] = _connectionString,
