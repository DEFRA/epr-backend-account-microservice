...
public class ServiceRoleExtensionsTests
{
    ...
    {
        // Act
        var result = ServiceRoleExtensions.GetHighestServiceRole(serviceRoles, Service.RegulatorEnrolment);
    ...
    [DataRow(new string[0], Packaging.ApprovedPerson.Key)]
    ...
    {
        // Act
        var result = ServiceRoleExtensions.GetAuthorizedRolesToRemoveUser(serviceRoleToRemove, Service.RegulatorEnrolment);
