...
public class AccountManagementServiceTests
{
    ...
    public async Task When_User_Is_Enrolled_With_No_Invited_Enrolments_Return_False()
    {
        ...
        _accountContext.Enrolments.Single().EnrolmentStatusId = Data.DbConstants.EnrolmentStatus.Enrolled; // query will no longer find an Enrolment with status of Invited 
